...
class Settings(BaseSettings):
    ...
    embedding_max_input_chars: int = Field(default=24000, ge=1000)
    embedding_timeout_seconds: int = Field(default=30, ge=1)
    embedding_max_retries: int = Field(default=2, ge=0)
    embedding_cost_per_million_tokens_usd: float = Field(default=0.02, ge=0)
    ...
    answer_requests_per_hour: int = Field(default=10, ge=1)
    user_daily_llm_token_budget: int = Field(default=12000, ge=1)
    monthly_llm_cost_budget_usd: float = Field(default=15.0, ge=0)
    answer_llm_input_cost_per_million_tokens_usd: float = Field(default=0.25, ge=0)
    answer_llm_output_cost_per_million_tokens_usd: float = Field(default=2.0, ge=0)
